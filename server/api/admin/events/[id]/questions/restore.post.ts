...
export default defineEventHandler(async (event) => {
  ...
  const body = await readBody<RestoreQuestionBody>(event)
  ...
  await logAuditAction(callerId, 'question_restored', eventId, { questionId: question.id })
